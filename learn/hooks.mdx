---
title: "Hooks"
description: "Permissionless composable contracts that can be chained to execute any multi-chain DeFi strategy."
---
...
If you are interested in building hooks, jump straight to [Write a Hook](/build/hooks/write-a-hook).
