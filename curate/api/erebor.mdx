...
Vault detail includes onchain identity, managers, fees, PPS, balances, TVL, upkeep information, and allocation data when available.

Public discovery depends on more than deployment. A vault should have adequate upkeep, configured hooks, yield sources, strategy coverage, and catalog listing / availability before it is treated as live.
