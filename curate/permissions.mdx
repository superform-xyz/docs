...
- Full operational access: ladders, yield sources, merkle trees, strategies, pause/unpause, view-only user management
...
**Client-side:** `AuthGuard` checks `superman_is_manager` in localStorage and redirects unauthorized users.
