...
Superform's flagship SuperVaults are run to preserve capital, preserve redemption reliability, and earn durable onchain yield, in that order. They are built for flagship capital, not for experimental strategies, opportunistic yield chasing, or discretionary style drift.
...
If an allocation cannot be monitored, simulated, and exited with confidence, it does not belong in Superform's flagship policy.
...
The anchor sleeve is the default home for capital. It holds the exposures that define Superform's flagship policy.
...
This policy does not promise instant redemption in all market states. It states the liquidity profile Superform's flagship SuperVaults are built to support, the stressed conditions that can delay exits, and the actions available when prompt withdrawals come under pressure.
...
By design, this flagship policy excludes:
