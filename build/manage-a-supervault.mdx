...
<Note>
For a guided management experience, use the curator application at [curators.superform.xyz](https://curators.superform.xyz). See the full [Curator Documentation](/curate) for the complete operational guide.
</Note>
