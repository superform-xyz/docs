...
```json
{
  ...
  "data": {
    ...
    "s3_url": "https://erebor-merkle-trees-231862524346.s3.eu-north-1.amazonaws.com/vaults/1/0x01c427580a2dfbdd894dabc4bff6c1dce7aab53c/e31ee747-c953-4a9d-ba28-0296c12397ec.json",
    "total_leaves": 4,
...
`is_stale: true` means the manager has created or activated a new hook configuration **after** the last publish. The published artifact at `s3_url` was generated from an older config version.
