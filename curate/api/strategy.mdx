...
description: "14 endpoints for creating and operating rule-based strategies, vault kill switches, and live shard state."
---

The Strategy Engine evaluates institution-defined rules and dispatches DeFiX intents to the OMS. It maintains in-memory **shards** for each active vault, running strategy tick loops.
