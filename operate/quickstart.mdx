...
Navigate to [institutions.superform.xyz](https://institutions.superform.xyz) and click **Connect Wallet**. Dynamic.xyz requests a signature to issue your JWT session. After connecting, the top navigation shows three sections: **Home** (global vault overview), **Operate** (per-vault management), and **Institutional** (admin operations).
</Step>
...
<Card title="Dashboard" icon="chart-line" href="/operate/ui/dashboard">
