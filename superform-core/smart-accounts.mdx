...
| SuperValidator | Validates same-chain Merkle proofs & bundled signatures (EIP-1271 compliant) |
| SuperDestinationValidator | Validates cross-chain Merkle proofs & bundled signatures (not EIP-1271 compliant, don't use for EntryPoint calls) |
