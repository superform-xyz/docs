...
This policy sets the construction standard for a flagship SuperVault.

The mandate is simple. Preserve capital. Preserve redemption reliability. Earn durable onchain yield. In that order.

This is not a yield leaderboard, strategy sandbox, or curator playground.

Every position must be defensible before entry, monitorable while live, and exitable under stress. If it fails that test, it does not belong in flagship capital, regardless of quoted APY, incentive support, or recent performance.

This page sets out Superform's example flagship policy. Curators may adapt it, but the standard should remain conservative, explicit, and enforceable.
...
The core belongs in anchor. Tactical improves the book without redefining it. PT is allowed, but capped and monitored. Liquidity is a live constraint.
