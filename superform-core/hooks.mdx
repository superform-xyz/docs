...
If you're interested in building hooks, jump straight to [Write Hooks](/build-on-superform/write-hooks).
...
The execution of hooks is a three‑step sequence bundled in the hooks `build()` function:
