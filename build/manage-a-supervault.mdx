...
<Note>
For a guided operating experience, use the curator application at [curators.superform.xyz](https://curators.superform.xyz). See the full [Operate Documentation](/operate) for the complete operational guide.
</Note>
