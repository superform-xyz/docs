...
Both hook-root flows pass through the aggregator's configurable hook-root timelock. Protocol governance can update that delay, including setting it to zero.
