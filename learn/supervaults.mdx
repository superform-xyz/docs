...
| Component | Role |
| --- | --- |
| **\$UP Token** | Protocol token used for governance via sUP, with validator-bonding utility introduced in later phases. Upkeep tokens for PPS update writes are configurable by chain. |
