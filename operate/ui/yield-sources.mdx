...
![SuperVaults Yield Source Management — whitelisted yield sources table with type and oracle assignments](/operate/images/screenshots/yield-sources.jpg)
...
All add/remove/update operations use the prepare pattern: Erebor constructs onchain calldata, your wallet signs the transaction.

## Page Layout

**Whitelisted Yield Sources:** The main table shows yield sources currently onchain for your vault, with name, address, oracle assignment, type (`erc4626` or `pendle_pt`), and actions (Remove, Update Oracle).
