...
<CardGroup cols={2}>
  ...
  <Card title="Configuration + Monitoring" icon="sliders" href="/build/become-a-validator/configuration-reference">
    Config reference, health endpoints, metrics, and alert rules.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Configuration + Monitoring" icon="sliders" href="/build/become-a-validator/configuration-reference">
    Config reference plus health endpoints, metrics, and alert rules.
  </Card>
  <Card title="How It Works + Economics" icon="diagram-project" href="/build/become-a-validator/how-it-works">
    OCR2 rounds, quorum, failure modes, rewards, staking, and rollout phases.
  </Card>
</CardGroup>
