...
Execution, validation, accounting, smart accounts, and gas contracts share the same address across all supported chains.
...
<Warning>
Hook addresses may vary across chains. Always verify hook addresses against the on-chain registry before integrating directly.
</Warning>
