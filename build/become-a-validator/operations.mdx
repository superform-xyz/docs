...
During Phase 1, Superform calls `SuperGovernor.setValidatorConfig()` on your behalf. Once the transaction confirms, your node should pick up the new validator set automatically.
...
<Card title="Monitoring" icon="chart-line" href="/build/become-a-validator/monitoring">
  Full metrics and alerting reference.
</Card>
