...
An institution manages a SuperVault's yield strategy: which protocols receive capital, in what order, under what conditions, and with what risk parameters. The institution does not hold depositor funds — the vault contract does.
...
<Note>
SuperVault contracts are live onchain and fully non-custodial. The institutional dashboard at [institutions.superform.xyz](https://institutions.superform.xyz) is a management layer — it never holds keys or assets. All vault interactions are direct onchain transactions signed by your wallet.
</Note>
